            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                <h1 className="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Professional Hair Transplant in Istanbul
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Experience world-class hair transplant procedures with our expert team. We specialize in FUE and DHI methods, ensuring natural-looking results.
                </p>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Professional Hair Transplant Services
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            We provide comprehensive hair transplant solutions with state-of-the-art technology and experienced medical professionals.
          </p>
        </div>
